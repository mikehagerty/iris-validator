...
### Install
  ...
  1. You can manually download the latest python wheel (*.whl) or distribution (*.gz):
...
Install using pip:
    ...
    >pip install yasmine_cli-0.0.2-py2.py3-none-any.whl

Note that the version number may change.
Current version is 0.0.2 (major.minor.patch)

  2. Alternatively, you can clone the repository and install from there:
